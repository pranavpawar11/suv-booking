  ...
  const fetchCarData = async () => {
    try {
      ...
      setFormData({
        ...
        seatingCapacity: car.seatingCapacity || 7,
        luggageCapacity: car.luggageCapacity || 3,
        ...
        features: {
          ac: car.features?.ac ?? true,
          musicSystem: car.features?.musicSystem ?? true,
          gps: car.features?.gps ?? true,
          pushBackSeats: car.features?.pushBackSeats ?? false,
        },
        insurance: {
          provider: car.insurance?.provider || '',
          policyNumber: car.insurance?.policyNumber || '',
          expiryDate: car.insurance?.expiryDate ? car.insurance.expiryDate.split('T')[0] : '',
        },
        puc: {
          certificateNumber: car.puc?.certificateNumber || '',
          expiryDate: car.puc?.expiryDate ? car.puc.expiryDate.split('T')[0] : '',
        },
      });
    } catch (error) {
  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600 mt-1">Update car information</p>
      </div>

      {/* Form - Same structure as AddCar */}
